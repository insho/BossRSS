...
//
//                // Note: Only showing the first pic (if there are multiple pics)
//                try {
//                    this.contentURL = item.getContent().get(0).getUrl();
//                } catch (Exception e) {
//                    Log.e("TEST", "Parceble item: could not load contentURL", e);
//                }
//
...
//                    } catch (Exception e) {
//                        Log.e("TEST", "Parceble item: could not load Content mediaThumbnail", e);
//                    }
//
//                } else if(item.getThumbnailList() != null) {
//                    try {
//                        this.mediaThumbnail = item.getThumbnailList().get(0).getUrl();
//                    } catch (Exception e) {
//                        Log.e("TEST", "Parceble item: could not load mediaThumbnailList", e);
//                    }
//                }
//
//                try {
...
//                } catch (Exception e) {
//                    Log.e("TEST", "Parceble item: could not load mediaDescription", e);
//                }
//
//            } else {
//                Log.e("TEST", "Item CONTENT is null");
//            }
//
...
//                } catch (Exception e) {
//                    Log.e("TEST", "Parceble item: could not load enclosureLink", e);
//                }
//
...
//                } else {
//                    Log.e("TEST", "Parceble item: could not load enclosureLength");
//                }
//
//                try {
//                    this.enclosureType = item.getEnclosure().getType();
//                } catch (Exception e) {
//                    Log.e("TEST", "Parceble item: could not load enclosureType", e);
//                }
//
//
//            } else {
//                Log.e("TEST", "Item GetENLCOSURE is null");
//            }
//
//
//        }
